...
import { portfolioData, reelsData, knowledgeBase, siteMeta, studioStats } from '../data/portfolio';
  ...
  return (
    <div ref={containerRef} style={{ background: 'var(--color-bg)' }}>
      ...
      <div className="footer-reveal-wrapper">
        ...
        <section className="hero-section" style={{ height: '100vh', position: 'relative', overflow: 'hidden', background: 'var(--color-bg)' }}>
        ...
        `}</style>
          ...
          <div ref={heroTextRef} style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', textAlign: 'center', width: '100%', pointerEvents: 'none', zIndex: 3 }}>
            ...
            <h1 ref={heroHeadlineRef} style={{ fontSize: 'clamp(3.5rem, 10vw, 8rem)', color: 'var(--color-ivory)', marginBottom: '3.5rem', pointerEvents: 'auto', letterSpacing: '-0.02em', lineHeight: 1 }}>
              ...
              <br />
              <span style={{ fontStyle: 'italic', fontWeight: 400, opacity: 0.9 }}><SplitText>Films.</SplitText></span>
            </h1>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', pointerEvents: 'auto' }}>
              <p className="subtitle-mono" style={{ color: 'var(--color-gold)', fontSize: '0.55rem', letterSpacing: '6px', marginBottom: '3rem' }}>
                KERALA &mdash; DUBAI &mdash; WORLDWIDE
              </p>
            </div>
          </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '4vw', alignItems: 'flex-start' }}>
              ...
              <div className="about-text-col" style={{ gridColumn: '2 / 7', paddingTop: '5vh' }}>
                ...
                <div className="premium-text-block" style={{ marginTop: '2rem' }}>
                  <p style={{ fontSize: '1.3rem', fontFamily: 'var(--font-heading)', color: 'var(--color-gold)', fontStyle: 'italic', marginBottom: '1rem', letterSpacing: '0.05em' }}>
                    We are a wedding photography and film team based in Kerala and Dubai.
                  </p>
                  <p style={{ fontSize: '1.05rem', color: 'rgba(17, 17, 17, 0.7)', lineHeight: 2, maxWidth: '480px', fontWeight: 300 }}>
                    We cover weddings the way they actually happen &mdash; the quiet moments before the ceremony, the tears, the laughter, the dancing at midnight. No forced poses, no stiff group shots you'll never look at twice.
                    <br /><br />
                    Every couple gets a film and a photo album they'll actually want to sit down and watch again, whether you're celebrating in Kerala, Dubai, or anywhere else in the world.
                  </p>
                </div>
                ...
                <div style={{ marginTop: '4rem', display: 'flex', alignItems: 'center', gap: '2rem' }}>
                  ...
                  <Link to="/about" className="interactive" style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '3px', color: 'var(--color-bg)', fontWeight: 600, textDecoration: 'none' }}>Discover Our History</Link>
                </div>
              </div>
              ...
              <div className="about-image-col" style={{ gridColumn: '8 / 13', position: 'relative' }}>
                <div style={{ height: '85vh', overflow: 'hidden', position: 'relative' }}>
                  <img className="img-parallax" src="/images/wedding_details_1774728672884.jpg" alt="Wedding portrait detail" loading="lazy" decoding="async" style={{ width: '100%', height: '130%', objectFit: 'cover', top: '-15%', position: 'absolute', display: 'block', willChange: 'transform' }} />
                </div>
                ...
                <div className="archive-seal">
                  <svg viewBox="0 0 100 100" width="100" height="100">
                    ...
                    <text fontSize="6.5" fontFamily="'Outfit', sans-serif" letterSpacing="3" fill="var(--color-gold)">
                      <textPath href="#circlePath">{`ESTD ${siteMeta.foundedYear} • KERALA & DUBAI •`}</textPath>
                    </text>
                  </svg>
                </div>
              </div>
          ...
          <div className="container-wide">
            <div className="philosophy-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '0' }}>
              <div className="philosophy-item" style={{ borderTop: '1px solid rgba(212,175,55,0.25)', padding: '3rem 3rem 3rem 0', transition: 'border-color 0.4s ease' }}>
                ...
                <h3 style={{ fontSize: '2.2rem', marginBottom: '1.5rem', transition: 'color 0.4s ease' }}><SplitText className="reveal-liquid" style={{ whiteSpace: 'nowrap' }}>Real Moments</SplitText></h3>
                <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', lineHeight: 1.9 }}>We stay quiet and watch for real emotions &mdash; a look, a laugh, a tear &mdash; instead of stopping the day for staged photos.</p>
              </div>
              <div className="philosophy-item" style={{ borderTop: '1px solid rgba(212,175,55,0.25)', padding: '3rem', transition: 'border-color 0.4s ease' }}>
                ...
                <h3 style={{ fontSize: '2.2rem', marginBottom: '1.5rem', transition: 'color 0.4s ease' }}><SplitText className="reveal-liquid" style={{ whiteSpace: 'nowrap' }}>Safe Keeping</SplitText></h3>
                <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', lineHeight: 1.9 }}>Your photos and films are backed up and handled with care from the day we shoot until the day we deliver &mdash; nothing gets lost.</p>
              </div>
              <div className="philosophy-item" style={{ borderTop: '1px solid rgba(212,175,55,0.25)', padding: '3rem 0 3rem 3rem', transition: 'border-color 0.4s ease' }}>
                ...
                <h3 style={{ fontSize: '2.2rem', marginBottom: '1.5rem', transition: 'color 0.4s ease' }}><SplitText className="reveal-liquid" style={{ whiteSpace: 'nowrap' }}>For Life</SplitText></h3>
                <p style={{ color: 'var(--color-text-muted)', fontSize: '0.9rem', lineHeight: 1.9 }}>Your wedding photos and films become part of your family's story. We make sure they still feel special 20 years from now.</p>
              </div>
            </div>
          </div>
        ...
        <section className="section section-no-top" style={{ paddingBottom: 0 }}>
          ...
          <div className="container-wide" style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <h2 style={{ fontSize: 'clamp(3rem, 10vw, 8rem)', marginBottom: '1.5rem' }}>
              <SplitText className="reveal-liquid">Our Services.</SplitText>
            </h2>
            <span className="subtitle-mono" style={{ color: 'var(--color-gold)' }}>WHAT WE OFFER</span>
          </div>
          <div className="services-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '2px', padding: '2rem 5vw', background: 'transparent' }}>
            {[
              { id: 'hazeera-tanveer', title: 'Engagement Shoots', desc: 'A relaxed shoot before the wedding', col: '1 / 5' },
              { id: 'namra-arshad', title: 'Wedding Coverage', desc: 'Full-day photo and film coverage', col: '5 / 9' },
              { id: 'ruksar-basith', title: 'Editing & Color', desc: 'In-house editing for every project', col: '9 / 13' }
            ].map((service, index) => {
              const portData = portfolioData.find(p => p.id === service.id) || portfolioData[0];
              return (
                <div key={index} className="service-card interactive" style={{ gridColumn: service.col, height: '78vh', position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Interactive Instagram-style Wedding Stories */}
        <WeddingStories />
        ...
        <section ref={storiesWrapRef} id="wedding-films" className="section stories-wrap" style={{ background: 'var(--color-bg)', padding: 0, overflow: 'hidden', position: 'relative' }}>
          ...
          <div className="container-wide stories-header-wrap" style={{ position: 'relative', paddingTop: '7rem', paddingBottom: '2rem', textAlign: 'center', zIndex: 10 }}>
            ...
            <span className="subtitle-mono" style={{ fontSize: '0.6rem', color: 'var(--color-gold)', marginTop: '0.5rem', display: 'block', textTransform: 'uppercase', letterSpacing: '4px' }}>Recent Work</span>
          </div>
          <div ref={storiesContainerRef} className="stories-container" style={{ display: 'flex', gap: '3rem', padding: '2rem 5vw 6rem 5vw', width: 'fit-content', willChange: 'transform' }}>
            ...
            <div style={{ width: '30vw', minWidth: '300px', height: '65vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Link to="/gallery" className="btn-premium-diamond interactive">See More Weddings</Link>
            </div>
          </div>
          <div className="diamond-separator"></div>
        </section>
        ...
        <section className="section" style={{ background: 'var(--color-bg)', padding: '10vh 0', overflow: 'hidden' }}>
          <div className="container-wide" style={{ marginBottom: '6rem' }}>
            <div className="red-dot"></div>
            <span className="subtitle-mono" style={{ fontSize: '0.6rem', color: 'var(--color-gold)', display: 'block', textAlign: 'center', marginBottom: '1rem' }}>Printed, Not Just Digital</span>
          ...
          <div className="magazine-ribbon" style={{ display: 'flex', gap: '2vw', padding: '0 5vw', overflow: 'hidden' }}>
            {portfolioData.filter(p => p.category === 'Magazine Album').map((album, i) => (
              <Link
                ...
                className="magazine-card interactive"
                style={{ flex: '0 0 35vw', minWidth: '400px', height: '500px', position: 'relative', background: '#111', overflow: 'hidden', display: 'block', textDecoration: 'none' }}
              >
          ...
          <div className="container-wide" style={{ marginTop: '2rem', textAlign: 'center' }}>
            <p style={{ color: 'var(--color-taupe)', fontSize: '0.9rem', maxWidth: '500px', margin: '0 auto' }}>
              Our wedding albums are designed and printed in our Dubai studio &mdash; a real, physical keepsake for your family, not just files sitting on a drive.
            </p>
          </div>
          <style>{`
        ...
        {/* 6. Editorial Manifesto Band */}
        <section className="section" style={{ background: 'var(--color-ivory)', color: 'var(--color-text-dark)', padding: '10rem 0' }}>
          <div className="container-wide" style={{ maxWidth: '900px', textAlign: 'center' }}>
            <span style={{ fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '4px', color: 'var(--color-taupe)', display: 'block', marginBottom: '3rem' }}>
              Why Couples Choose Us
            </span>
            <p style={{ fontSize: 'clamp(1.6rem, 3.5vw, 2.6rem)', lineHeight: 1.4, fontFamily: 'var(--font-serif-elegant)', fontWeight: 300, fontStyle: 'italic', color: 'var(--color-text-dark)' }}>
              We show up, stay out of the way, and capture your wedding as it really
              happens &mdash; then hand you a film and album you'll actually want
              to show your grandkids.
            </p>
            <div className="diamond-separator" style={{ borderColor: 'rgba(0,0,0,0.1)', marginTop: '3.5rem' }}></div>
          </div>
        </section>
        ...
        <section className="section faq-section" style={{ background: 'var(--color-ivory)', padding: '10rem 0', borderTop: '1px solid rgba(0,0,0,0.03)' }}>
          <div className="container-wide" style={{ maxWidth: '1000px' }}>
            <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
              <div className="red-dot"></div>
              <span className="subtitle-mono" style={{ fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '6px', color: 'var(--color-gold)', display: 'block', marginBottom: '1.5rem' }}>FAQ</span>
              <h2 style={{ fontSize: 'clamp(3rem, 6vw, 5rem)', fontFamily: 'var(--font-heading)', color: 'var(--color-bg)' }}>
                Common Questions<span style={{ color: 'var(--color-gold)' }}>.</span>
              </h2>
            </div>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
              {knowledgeBase.slice(0, 4).map((item, index) => (
            ...
            <div style={{ textAlign: 'center', marginTop: '4rem' }}>
              <Link to="/inquire" className="interactive" style={{ fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '3px', color: 'var(--color-bg)', fontWeight: 600, borderBottom: '1px solid var(--color-gold)', paddingBottom: '0.5rem' }}>
        ...
        <section id="inquiry" className="section" style={{ background: 'var(--color-bg)', color: 'var(--color-ivory)', minHeight: '100vh', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="container-wide" style={{ width: '100%', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              <span style={{ fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '6px', color: 'var(--color-gold)', display: 'block', marginBottom: '2.5rem' }}>Get In Touch</span>
              <h2 style={{ fontSize: 'clamp(3.5rem, 8vw, 7rem)', lineHeight: 0.9, marginBottom: '3rem', fontFamily: 'var(--font-heading)' }}>
                <SplitText className="reveal-liquid">Tell us about</SplitText><br />
                <SplitText className="reveal-liquid">your day.</SplitText>
              </h2>
              <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto 4rem auto', lineHeight: 1.8 }}>
                We only take on a limited number of weddings each year, so every couple gets our full attention. Reach out and we'll get back to you within 24 hours.
              </p>
        ...
        <section className="section" style={{ background: 'var(--color-bg)', padding: '10vh 0' }}>
          <div className="container-wide">
            <div style={{ marginBottom: '4rem', textAlign: 'center' }}>
              <span className="subtitle-mono" style={{ fontSize: '0.6rem', color: 'var(--color-gold)', letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '1rem', display: 'block' }}>From Instagram</span>
        ...
        <section className="section" style={{ background: 'var(--color-bg)', color: 'var(--color-ivory)', padding: '4rem 0', borderTop: '1px solid rgba(253, 251, 247, 0.05)' }}>
          ...
          <div className="container-wide" style={{ textAlign: 'center', marginBottom: '5rem' }}>
            ...
            <a href="https://www.instagram.com/_imcweddings_/" target="_blank" rel="noopener noreferrer" className="interactive" style={{ fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '4px', fontWeight: 600, borderBottom: '1px solid var(--color-gold)', paddingBottom: '0.5rem', color: 'var(--color-gold)' }}>@_imcweddings_</a>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', padding: '0 5vw', backgroundColor: 'var(--color-bg)' }}>
            {[
              ...
              <a href="https://www.instagram.com/_imcweddings_/" target="_blank" rel="noopener noreferrer" key={i} className="interactive insta-link" style={{ overflow: 'hidden', aspectRatio: '1/1', display: 'block', position: 'relative' }}>
          ...
          <div className="container-wide">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '6vw', alignItems: 'flex-start' }}>
              <div style={{ gridColumn: '2 / 5' }}>
                <span className="subtitle-mono" style={{ fontSize: '0.6rem', textTransform: 'uppercase', letterSpacing: '4px', color: 'var(--color-gold)', display: 'block', marginBottom: '2rem' }}>Where We're Based</span>
                <h2 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 0.9, marginBottom: '3rem' }}>
                  <SplitText className="reveal-liquid">Kerala &amp;</SplitText><br />
                  <SplitText className="reveal-liquid">Dubai.</SplitText>
                </h2>
                <p style={{ color: 'var(--color-text-muted)', fontSize: '1rem', maxWidth: '400px', lineHeight: 1.8, marginBottom: '3rem' }}>
                  We have two studios &mdash; one in Kerala, one in Dubai &mdash; so we can shoot weddings across India, the UAE, and beyond without losing the personal touch.
                </p>
                <div style={{ borderLeft: '1px solid var(--color-gold)', paddingLeft: '1.5rem' }}>
                  <span style={{ fontSize: '0.6rem', color: 'var(--color-gold)', textTransform: 'uppercase', letterSpacing: '2px' }}>Bookings</span>
                  <p style={{ fontSize: '1rem', marginTop: '0.5rem' }}>Open for 2026/27</p>
                </div>
              </div>

              <div style={{ gridColumn: '6 / 12' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3vw' }}>
                  <div className="interactive studio-card" style={{ padding: '4rem 3rem', background: 'rgba(253, 251, 247, 0.03)', border: '1px solid rgba(253, 251, 247, 0.05)', transition: 'background 0.6s ease' }}>
                    <h4 style={{ fontSize: '1.5rem', color: 'var(--color-ivory)', marginBottom: '1.5rem', fontFamily: 'var(--font-heading)', fontWeight: 400 }}>Kerala</h4>
                    <p style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '2px', lineHeight: 2, color: 'var(--color-taupe)' }}>
                      ...
                      <span style={{ color: 'var(--color-gold)', marginTop: '1rem', display: 'inline-block' }}>{siteMeta.contact.indiaDesk.display}</span>
                    </p>
                  </div>

                  <div className="interactive studio-card" style={{ padding: '4rem 3rem', background: 'rgba(253, 251, 247, 0.03)', border: '1px solid rgba(253, 251, 247, 0.05)', marginTop: '6vh', transition: 'background 0.6s ease' }}>
                    <h4 style={{ fontSize: '1.5rem', color: 'var(--color-ivory)', marginBottom: '1.5rem', fontFamily: 'var(--font-heading)', fontWeight: 400 }}>Dubai</h4>
                    <p style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '2px', lineHeight: 2, color: 'var(--color-taupe)' }}>
                      IN5, PRODUCTION CITY<br />
                      DUBAI, UNITED ARAB EMIRATES<br />
                      <span style={{ color: 'var(--color-gold)', marginTop: '1rem', display: 'inline-block' }}>{siteMeta.contact.uaeDesk.display}</span>
                    </p>
                  </div>
                </div>
              </div>
